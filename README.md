I'm a computer science college student who likes building things that are useful for me and hopefully for others too. Most of what I work on or create involves [modding](https://en.wikipedia.org/wiki/Modding), so I'm more into reverse-engineering than software development. These days, my focus is on [web development](https://en.wikipedia.org/wiki/Web_development) as a way to get into "proper software development". 
